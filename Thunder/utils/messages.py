...
MSG_WELCOME = (
    "🌟 **خوش اومدی, {user_name}!** 🌟\n\n"
    "من **Persian File to Link**ربات هستم ⚡\n"
    "برای فایل‌هایت لینک دانلود مستقیم و پخش آنلاین می‌سازم.\n\n"
    "**نحوه استفاده:**\n"
    "1. در گفت‌وگوی خصوصی، هر فایلی را برایم بفرست تا لینک اختصاصی دریافت کنی.\n"
